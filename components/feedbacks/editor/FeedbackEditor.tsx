...
export default function FeedbackEditor() {
  ...
  } = useMediaUpload("feedbackAttachment");
  ...
  const titleEditor = useEditor({
    extensions: [
      StarterKit.configure({
        // Disabilita le estensioni non necessarie per il titolo
        heading: false,
        bulletList: false,
        orderedList: false,
        codeBlock: false,
      ...
      Placeholder.configure({
        placeholder: "Inserisci un breve titolo...",
      }),
    ],
    content: "",
  });
  ...
  const editor = useEditor({
    extensions: [
      ...
      Placeholder.configure({
        placeholder: "Scrvi i tuoi suggerimenti o segnalazioni...",
      }),
    ],
  });
    ...
    <div className="flex flex-col gap-5 rounded-2xl bg-card p-5 shadow-sm">
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <LoadingButton
          ...
          disabled={!title.trim() || !input.trim() || isUploading}
          className="min-w-20"
        >
          Post Feedback
        </LoadingButton>
